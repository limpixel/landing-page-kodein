@extends('layouts.app')
@section('title')
    keunggulan | Edit #ID {{ $keunggulan->id }}
@endsection
@section('js')
    <script>
        $(function() {
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">keunggulan | Edit #ID {{ $keunggulan->id }}</div>
                    <div class="card-body">
                        <form action="{{ route('backend.keunggulan.edit.process', $keunggulan->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <img src="{{ asset('images/keunggulan/'.$keunggulan->image1) }}" class="w-25" id="preview1">
                                        </div>
                                        @error('image')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <img src="{{ asset('images/keunggulan/'.$keunggulan->image2) }}" class="w-25" id="preview2">
                                        </div>
                                        @error('image2')
                                            <small class="text-danger">{!! $message !!}</small>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <img src="{{ asset('images/keunggulan/'.$keunggulan->image3) }}" class="w-25" id="preview3">
                                        </div>
                                        @error('image3')
                                            <small class="text-danger">{!! $message !!}</small>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <img src="{{ asset('images/keunggulan/'.$keunggulan->image4) }}" class="w-25" id="preview4">
                                        </div>
                                        @error('image4')
                                            <small class="text-danger">{!! $message !!}</small>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-2 @error('image5') text-danger fw-bold @enderror">Image:</div>
                                        <input class="form-control" type="file" name="image5" id="image5" >
                                        <div class="mb-3">
                                            <img src="{{ asset('images/keunggulan/'.$keunggulan->image5) }}" class="w-25" id="preview5">
                                        </div>
                                        @error('image5')
                                            <small class="text-danger">{!! $message !!}</small>
                                        @enderror
