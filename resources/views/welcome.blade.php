              ...
              <div class="carousel-item active">
                  ...
                  <div class="carousel-caption d-md-block">
                      ...
                      <div class="row justify-content-center">
                        <div class="m-2">
                            <a href="https://wa.me/6281703703111"
                            class="btn btn-success btn-style">Kontak</a>
    ...
    <div class="midd-w3 py-4">
        <div class="container py-lg-5 py-md-3">
            <div class="row align-items-center">
                <div class="col-lg-6">
                  <iframe src="https://www.youtube.com/embed/a1-mJjGyqcA"
                ...
                <div class="col-lg-6 col-sm-12">
                    <h1 class="mb-2 title text-right"> <span>Segera</span> Daftarkan <span>Putra Anda! Kuota </span>
                        Terbatas!</h1>
                    <p class="sub text-right mb-2">Pesantren Koding adalah sekolah yang
                        mencetak full stack developer dan software engineer siap pakai.
                        Dengan metode pembelajaran praktek di Inkubator
                        dan di supervisi dengan mentor-mentor
                        yang sudah berpengalaman selama 10 tahun.</p>
                    <p class="sub text-right mb-2">Pesantren Koding sudah memiliki legalitas
                        NO SK/Izin Operasional Sekolah: 0711220081886
                        NPSN: P9998718.</p>
                    <div class="text-right">
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSeDoavH5vKqE2XnzlsBcVWbXnT8_1TLnpy7546eoF9wYgAYEA/viewform?embedded=true" class="btn btn-primary btn-style">Daftar</a>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="midd-w3 py-4">
          <div class="container py-lg-5 py-md-3">
              <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                      <iframe src="https://www.youtube.com/embed/hyFn1tXGjPQ" title="YouTube video player" frameborder="0"
                          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  ...
  <section id="home" class="w3l-index3 bg-orange">
      <div class="midd-w3 py-4">
          <div class="container py-lg-5 py-md-3">
              <div class="row align-items-center">
                  <div class="col-lg-6">
                      <iframe src="https://www.youtube.com/embed/-HUotKkJawY"
                      title="YouTube video player" frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowfullscreen class="radius-image gambar shadow w-100" style="height: 300px; object-fit: cover;"></iframe>
                  </div>
                  <div class="col-lg-6 col-sm-12">
                      ...
                      <p class="sub mb-2 text-right">Badan usaha khusus dibawah naungan Yayasan yang melayani pembuatan berbagai
          ...
          <div class="container py-lg-5 py-md-3">
              <div class="row align-items-center">
                  ...
                  <div class="col-lg-6 col-sm-12">
                      ...
                      <p class="sub mb-2 text-right">Program yanng dipersiapkan pesantren koding selama 2 Bulan di Kampung English Pare. Dengan Menguasai Bahasa Ingris yang merupakan bahasa pengantar dalam pembelajaran IT Sehingga siswa dapat memahami dengan mudah  materi materi disampaikan  Bahasa Ingris Sebagai Bahasa Komunikasi dalam Dunia Industri/Dunia Usaha dengan demikian Siswa dapat Go International</p>
                  </div>
          ...
          <div class="container py-lg-5 py-md-3">
              <div class="row align-items-center">
                  <div class="col-lg-6 col-sm-12">
                      ...
                      <p class="sub mb-2">Pesantren Koding Mendatangkan Mentor Mentor Akademik dari Bimbingan Belajar Yang Sudah Ternama dengan Metode Belajar Sistem Blok Siswa Diajarkan Fokus Kepada materi materi yang berhubungan dengan Industri IT dan UTBK
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  ...
                  <div class="col-lg-6 col-sm-12">
                      ...
                      <p class="sub mb-2 text-right">Pesantren Koding memberikan pembekalan ilmu diniyah dan adab , siswa diberikan pembekalan tujuan hidup yang sebenarnya tidak hanya mencari materi dan kebahagian dunia yang fana. siswa diajarkan bagaimana adab yang baik dalam berinteraksi dengan keluarga dan masyakat.
                        Kepala Sekolah Pesantren Koding yang merupakan lulusan Universitas Islam Madinah akan membimbing siswa Fiqih dan Adab dalam Islam</p>
                  </div>
                      ...
                      <div class="item">
                          <div class="testimonial-content">
                              <div class="testimonial">
                                  <blockquote>
                                      <q>Pesantren Koding merupakan sekolah yang mempersiapkan siswa untuk bisa langsung siap
